...
export declare const ORDER_OPEN = "OPEN";
export declare const ORDER_FILLED = "FILLED";
...
export declare const TRADE_FEE_RATE: 0.05;
export declare function calcTradeFeeSilver(grossSilver: number): number;
