...
## Pitches y propuestas de diseño

| Documento | Propósito |
|-----------|-----------|
| [DESIGN_PITCH_INITIAL_LINEAGES.md](./DESIGN_PITCH_INITIAL_LINEAGES.md) | Propuesta de 4 Linajes Iniciales: Zolz, Uren, Draen y Vael. |
