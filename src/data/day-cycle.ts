...
const RESOURCE_WINDOWS_GLOBAL = {
    ...
    'elemental core': 'all',
    'emerald': 'all',
    'essence of shadow': 'night',
    'feather': 'all',
    'fire resistance potion': 'all',
    'flor dragon': 'crepuscular',
    'flordragon': 'crepuscular',
    'flores': 'daylight',
    'flores amarillas': 'daylight',
    'frost lotus': 'all',
    'ghostcap mushroom': 'night',
    'girasol': 'daylight',
    'girasoles': 'daylight',
    'gold ore': 'all',
    'greater health potion': 'all',
    'health potion': 'all',
    'hemp fiber': 'all',
    'hierba': 'daylight',
    'hierbas': 'daylight',
    ...
    'silk fiber': 'all',
    'silver ore': 'all',
    'small health potion': 'all',
    'small stamina potion': 'all',
    'spider silk': 'all',
    'stamina potion': 'all',
    'sulfur': 'all',
    'tin ore': 'all',
