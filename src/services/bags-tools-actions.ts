...
import { getEquipmentSlotLabel, getToolRequirement } from './bags-equipment-utils.js';
...
import { buildBagUsage, buildCapacityReason, ensurePlayerEquipment, getEquippedToolIdsFromEquipment, unequipToolIfEquipped } from './bags-core.js';
